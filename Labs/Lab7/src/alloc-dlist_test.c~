...
int main(int argc, char *argv[]) {
  ...
  dlist_add_back(mylist, str1, sizeof(char) * 20);
  dlist_add_back(mylist, str2, sizeof(char) * 20);
  dlist_add_back(mylist, str3, sizeof(char) * 20);
  dlist_add_back(mylist, str4, sizeof(char) * 20);
  dlist_add_back(mylist, str5, sizeof(char) * 20);
  ...
  dlist_add_front(mylist, str1, sizeof(char) * 20);
  dlist_add_front(mylist, str2, sizeof(char) * 20);
  dlist_add_front(mylist, str3, sizeof(char) * 20);
  dlist_add_front(mylist, str4, sizeof(char) * 20);
  dlist_add_front(mylist, str5, sizeof(char) * 20);
